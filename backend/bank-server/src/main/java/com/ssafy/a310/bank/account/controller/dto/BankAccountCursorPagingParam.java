...
public class BankAccountCursorPagingParam extends CursorPagingParam {
    private static final String[] validOrderKeys = {"number", "bankName", "createdAt", "lastTransactionAt"};

    public BankAccountCursorPagingParam(boolean isFirstPage, Integer pageSize, String lastUuid, String orderKey, String orderDirection, List<String> segment) {

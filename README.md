...
|                                                                                           |                                                                                                        |                                                                                                          |
| :---------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------- |
| [1. 프로젝트 정보](#-프로젝트-정보)</br>[2. 주제](#-주제)</br>[3. 기획 배경](#-기획-배경) | [4. 서비스 화면](#-서비스-화면)</br>[5. 서비스 특징](#-서비스-특징)</br>[6. 산출물](#%EF%B8%8F-산출물) | [7. 기술 스택](#-기술-스택)</br>[8. 팀원](#-팀원)</br>[회고 보러가기 ✍️](https://allkong.tistory.com/80) |
...
|                                  (관객) 포토카드 제작                                  |                               (관객) 포토카드 공유                                |                                    (모두) 포토카드 확인                                    |

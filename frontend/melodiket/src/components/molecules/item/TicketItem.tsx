...
const TicketItem = ({
  ...
  return (
    <div className="flex items-center p-4 space-x-4 bg-white border-b border-purple-50">
      <div className="relative flex-shrink-0 w-[4.5rem] h-[6.2rem] overflow-hidden rounded-md">
